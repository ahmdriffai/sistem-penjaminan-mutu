...
@section('content')
    ...
    <a class="btn btn-primary mb-3" href="{{ route('pengumuman.create') }}">
        <i class="bx bx-plus-circle me-1"></i> Tambah Pengumuman
    </a>
    <div class="card">
        <div class="d-flex align-items-center flex-row justify-content-around">
            <h5 class="card-header flex-grow-1">List Pengumuman</h5>
            ...
            <table class="table table-hover">
                ...
                @foreach($data as $value)
                    <tr>
                        ...
                        <td>
                            <a target="_blank" href="{{ $value->file_url }}">Preview</a>
                        </td>
                        <td>{!! $value->isi !!}</td>

                        <td class="d-flex">
                            <a class="btn btn-sm btn-primary mx-1" href="{{ route('pengumuman.edit', $value->id) }}">
