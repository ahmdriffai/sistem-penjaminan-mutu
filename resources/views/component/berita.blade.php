<div class="container">
    <div class="row mt-5 gx-5 gy-3">
        <div class="col-md-12">
            <h3 class="text-danger text-center mb-5"><i class="fas fa-newspaper"></i> Berita</h3>
            <div class="row g-5">
                @foreach($berita as $value)
                    <div class="col-md-4">
                        <div class="card card-berita">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><a href="{{ route('detail-berita', $value->id) }}" class="link-danger">{{ $value->judul }}</a></h5>
                                ...
                                <a href="{{ route('detail-berita', $value->id) }}" class="link-danger">selengkapnya ></a>
                            </div>
                        </div>
                    </div>
                @endforeach
